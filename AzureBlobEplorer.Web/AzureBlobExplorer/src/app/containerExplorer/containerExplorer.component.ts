...
export class ContainerExplorerComponent implements OnInit {
    ...
    public containerDetailsTableColumns: string[] = ['icon', 'name', 'lastModified'];

    constructor(private _containerExplorerService: ContainerExplorerService, private _router: Router, private _dialog: MatDialog) { }
    ...
    public addContainer() {
        ...
        dialog.afterClosed().subscribe(x => { this.retrieveContainerDetails(); })
    }
